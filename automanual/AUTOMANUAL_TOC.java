...
public class AUTOMANUAL_TOC implements CobolRunnable {
  ...
  public int run(CobolDataStorage... argStorages) {
    return AUTOMANUAL_TOC_(0, argStorages);
  }
  ...
  public int AUTOMANUAL_TOC_ (int entry, CobolDataStorage ...argStorages) {
    this.entry = entry;
  ...
  int run_module (int entry) {
    ...
    /* Initialize program */
    if (!this.initialized) {
      module.setProgramId("AUTOMANUAL_TOC");
  ...
  public CobolControl[] contList = {
    new CobolControl(0, CobolControl.LabelType.label) {
      public Optional<CobolControl> run() throws CobolRuntimeException, CobolGoBackException, CobolStopRunException {
        ...
        return Optional.of(contList[l_AUTOMANUAL_TOC]);
      }
    },
    /* Entry AUTOMANUAL_TOC */
    new CobolControl(l_AUTOMANUAL_TOC, CobolControl.LabelType.label) {
      public Optional<CobolControl> run() throws CobolRuntimeException, CobolGoBackException, CobolStopRunException {
    ...
    new CobolControl(l_MAIN_CONTROL__MAIN_000, CobolControl.LabelType.label) {
      public Optional<CobolControl> run() throws CobolRuntimeException, CobolGoBackException, CobolStopRunException {
        /* AUTOMANUAL_TOC.cbl:51: ACCEPT */
        {
          CobolTerminal.acceptCommandLine (f_WRK_STRING);
        }
        /* AUTOMANUAL_TOC.cbl:52: UNSTRING */
        {
        ...
        /* AUTOMANUAL_TOC.cbl:67: MOVE */
        {
          b_NEW_FILE_PATH.fillBytes (32, 256);
        }
        /* AUTOMANUAL_TOC.cbl:68: STRING */
        {
        ...
        /* AUTOMANUAL_TOC.cbl:102: IF */
        {
          if (((long)f_MD_PREVIOUS.compareTo (CobolConstant.space) == 0L))
            {
              /* AUTOMANUAL_TOC.cbl:103: STRING */
              {
                CobolString.stringInit (f_NEW_REC, 0);
                CobolString.stringDelimited (0);
                CobolString.stringAppend (c_6);
        ...
        /* AUTOMANUAL_TOC.cbl:118: IF */
        {
          if (((long)f_MD_NEXT.compareTo (CobolConstant.space) == 0L))
            {
              /* AUTOMANUAL_TOC.cbl:119: STRING */
              {
                CobolString.stringInit (f_NEW_REC, 0);
                CobolString.stringDelimited (0);
                CobolString.stringAppend (c_5);
        ...
        /* AUTOMANUAL_TOC.cbl:137: PERFORM */
        for (;;)
          {
            if (((long)f_OLD_STS.compareTo (CobolConstant.zero) != 0L))
              break;
            {
              /* AUTOMANUAL_TOC.cbl:138: MOVE */
              {
                b_OLD_REC.fillBytes (32, 50000);
              }
              /* AUTOMANUAL_TOC.cbl:139: READ */
              CobolRuntimeException.code = 0;
              {
  ...
  public static void main(String[] args)
  {
    ...
    CobolDecimal.cobInitNumeric();
    new AUTOMANUAL_TOC().AUTOMANUAL_TOC_(0);
    CobolStopRunException.stopRun();
  }

  public AUTOMANUAL_TOC()
  {
    init();
  }
  ...
  /* Sections and Labels */
  private final static int l_AUTOMANUAL_TOC = 1;
